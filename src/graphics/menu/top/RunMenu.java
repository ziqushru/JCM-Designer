...
public class RunMenu extends Menu implements Configurations
{
	...
	private static TextField[]		parameters_text_fields;

	public RunMenu(MenuBar top_menu, String text)
	{
		super(text);
		RunMenu.run_configurations.setOnAction(event -> this.openConfigurations());
	...
	public void openConfigurations()
	{
		...
		RunMenu.parameters_text_fields = new TextField[parameters_length];
		...
		for (int i = 0; i < parameters_length; i++)
		{
			...
			RunMenu.parameters_text_fields[i] = new TextField();
			RunMenu.parameters_text_fields[i].setMaxWidth(64);
			RunMenu.parameters_text_fields[i].setAlignment(Pos.CENTER);
			RunMenu.parameters_text_fields[i].setFocusTraversable(false);
			parameters_grid_pane[i].add(RunMenu.parameters_text_fields[i], 1, 0);
	...
	{
		String n = RunMenu.parameters_text_fields[0].getText().toString();
		String g = RunMenu.parameters_text_fields[1].getText().toString();
		String N = RunMenu.parameters_text_fields[2].getText().toString();
		String e = RunMenu.parameters_text_fields[3].getText().toString();
