...
public class DifferentialMenu implements Configurations
{
	...
	public void openConfigurations()
	{
		...
		main_comp.getChildren().add(new Label("Differential Hebbian Learning Algorithm"));
		...
		Scene scene = new Scene(main_comp, 400, 440);
	...
	public void buttonOnAction()
	{
		...
		String e = this.parameters_text_fields[1].getText().toString();
