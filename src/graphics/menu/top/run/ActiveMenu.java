...
public class ActiveMenu extends RunConfigurations implements Configurations
{
	@Override
	public void openConfigurations()
	{
		...
		final CustomGridPane grid_pane = new CustomGridPane(2, 8);
		...
		parameters_labels[2] = new Label("b1");
		parameters_labels[3] = new Label("b2");
		parameters_labels[4] = new Label("l1");
		parameters_labels[5] = new Label("l2");
		parameters_labels[6] = new Label("e");
